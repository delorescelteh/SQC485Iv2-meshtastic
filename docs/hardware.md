...
| Pin | Net/名稱 | 功能 | 狀態 |
| --- | --- | --- | --- |
| 1 | POW_IN | 外部電源輸入 | 已由原理圖確認（CONN1 pin1 經 D5 進入） |
| 2 | GND | 電源地 | 已由原理圖確認（CONN1 pin2） |
| 3 | #A | RS485 A | 已由原理圖確認（CONN1 pin3） |
| 4 | #B | RS485 B | 已由原理圖確認（CONN1 pin4） |
...
| 項目 | 腳位 | 狀態 | 備註 |
| --- | --- | --- | --- |
| Battery ADC | N/A | 不支援 | 目前硬體無電池電壓量測腳位 |
